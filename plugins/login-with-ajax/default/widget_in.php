...
*/
?>
<div class="lwa" style="display: none;">
    <div class="lwa-logout-container">
        <?php
        ...
        <table>
            <tr>
                ...
                <td class="lwa-info">
                    ...
                    ?>
                    <a id="wp-logout"
                       href="<?php echo wp_logout_url(home_url()) ?>"><?php esc_html_e('Log Out', 'login-with-ajax') ?></a><br/>
                    <?php
                    //Blog Admin
                    if (current_user_can('list_users') && false) {
                        ?>
        ...
        <div class="mve-direct-access stick-to-bottom">
